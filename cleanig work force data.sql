...
drop column rownum;
 ...
 # i will remove location datas since i dont know where this exact data comefrom  i will not analysis how to impove the recruitment in a specific location
 -- and any personal info since all ineed are the id,Education level,years of expirnce desired salary,job titlem,status,application data
...
alter table recritment_stagging
